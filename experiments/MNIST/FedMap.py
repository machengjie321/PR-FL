import os
import torch
from bases.fl.simulation_real.Sub_FedMap import FedMapServer, FedMapClient,FedMapFL, parse_args
...
if __name__ == "__main__":
    ...
    server = FEMNISTFedMapServer(config, args, Conv2(), seed, SGD, {"lr": config.INIT_LR}, use_adaptive,
                           control=control_module, control_scheduler=control_scheduler,
                           resume=resume, init_time_offset=0,device=device)
