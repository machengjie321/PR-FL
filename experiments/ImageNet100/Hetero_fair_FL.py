...
class INFedMapServer(FedMapServer):
    ...
    def init_test_loader(self):
        self.test_loader = get_data_loader(EXP_NAME, data_type="val",batch_size=50, num_workers=config.test_num, pin_memory=True)
    ...
    def init_ip_config(self):
        ...
        self.ip_test_loader = get_data_loader(EXP_NAME, data_type="val", batch_size=50, num_workers=config.test_num,
                                              pin_memory=True)
