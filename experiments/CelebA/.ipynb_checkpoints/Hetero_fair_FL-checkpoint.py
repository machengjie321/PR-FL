...
class args:
    def __init__(self, parse_args=None):
        self.seed = 0
        self.experiment_name = 'Hetero_FL——[Hetero_fair_cuda20000_celeba]'
        self.min_density = 1
        self.density = [1,1]
...
if __name__ == "__main__":
    ...
    client_list = [INFedMapClient(list_models[idx], config, args.use_adaptive, exp_config = server.exp_config, args=args, device = device) for idx in range(NUM_CLIENTS)]
