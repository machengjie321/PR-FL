...
class args:
    def __init__(self):
        ...
        self.seed = 0
        self.experiment_name = 'Hetero_FL——[Hetero_fair_cuda_small_l2_10000round_coeff]'
        self.density = [1,0.5,0.91]
        ...
        self.experiment_name = self.experiment_name + '_' + str(self.density) + str(self.fair) + '_' + str(
            ...
            self.interval) + '_' + str(self.increase) + '_' + str(self.weight_decay) + '_' + self.merge
